        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            Text(
              ...
              'Your creations are private and can be used directly in army building.',
            ...
            const _PremiumFeature(icon: Icons.shield_outlined,
              label: 'Custom factions with unique colors'),
            const SizedBox(height: 10),
            const _PremiumFeature(icon: Icons.group_outlined,
              label: 'Custom units with full stats & abilities'),
            const SizedBox(height: 10),
            const _PremiumFeature(icon: Icons.flash_on_outlined,
              label: 'Custom abilities with cost calculation'),
            const SizedBox(height: 10),
            const _PremiumFeature(icon: Icons.inventory_2_outlined,
              label: 'Usable in army builder alongside official content'),
